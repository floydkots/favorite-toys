...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void loadSizeFromSharedPreferences(SharedPreferences sharedPreferences) {
        String prefSizeKey = getString(R.string.pref_size_key);
        String prefSizeDefault = getString(R.string.pref_size_default);
        String sizePreference = sharedPreferences.getString(prefSizeKey, prefSizeDefault);
        float minSize = Float.parseFloat(sizePreference);
