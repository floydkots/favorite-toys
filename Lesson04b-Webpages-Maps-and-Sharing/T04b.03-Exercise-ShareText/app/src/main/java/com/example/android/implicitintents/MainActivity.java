...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // COMPLETED TODO (5) Specify a String you'd like to share
        String text = "Hello there from the other side.";

        // COMPLETED TODO (6) Replace the Toast with shareText, passing in the String from step 5
        shareText(text);
    }
    ...
    public void shareText(String text) {
        ...
        String title = "Sharing Plain Text";
