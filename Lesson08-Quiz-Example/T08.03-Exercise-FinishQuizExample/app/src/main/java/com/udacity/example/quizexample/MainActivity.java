...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get the views
        // COMPLETED TODO (1) You'll probably want more than just the Button
    ...
    public void nextWord() {
        ...
        // COMPLETED TODO (3) Go to the next word in the Cursor, show the next word and hide the definition
        ...
        if (mData != null) {
            ...
            mTextViewDefinition.setText(mData.getString(mDefCol));
    ...
    protected void onDestroy() {
        super.onDestroy();
        // COMPLETED TODO (5) Remember to close your cursor!
        mData.close();
    }
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            // COMPLETED TODO (2) Initialize anything that you need the cursor for, such as setting up
