...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long totalMinuesUntilBoarding = info.getMinutesUntilBoarding();
        long hoursUntilBoarding = TimeUnit.MINUTES.toHours(totalMinuesUntilBoarding);
        long minutesLessHoursUntilBoarding =
                totalMinuesUntilBoarding - TimeUnit.HOURS.toMinutes(hoursUntilBoarding);
