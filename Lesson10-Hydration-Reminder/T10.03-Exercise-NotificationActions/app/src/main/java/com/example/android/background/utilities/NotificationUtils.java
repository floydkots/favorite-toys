...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 3517;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 3617;
    /**
     * This notification channel id is used to link notifications to this channel
     */
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "reminder_notification_channel";

    // COMPLETED TODO (1) Create a method to clear all notifications
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context,WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
                ...
                // COMPLETED TODO (17) Add the two new actions using the addAction method and your helper methods
    ...
    // COMPLETED TODO (5) Add a static method called ignoreReminderAction
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent ignoreRemdinderPendingIntent = PendingIntent.getService(
                context,
