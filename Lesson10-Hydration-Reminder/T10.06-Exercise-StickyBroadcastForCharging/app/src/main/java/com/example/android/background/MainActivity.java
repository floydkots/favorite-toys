...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        // COMPLETED TODO (1) Check if you are on Android M or later, if so...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            // COMPLETED TODO (2) Get a BatteryManager instance using getSystemService()
            // COMPLETED TODO (3) Call isCharging on the battery manager and pass the result on to your show
            // charging method
        ...
        // COMPLETED TODO (4) If your user is not on M+, then...
            // COMPLETED TODO (5) Create a new intent filter with the action ACTION_BATTERY_CHANGED. This is a
            // sticky broadcast that contains a lot of information about the battery state.
            // COMPLETED TODO (6) Set a new Intent object equal to what is returned by registerReceiver, passing in null
            ...
            // COMPLETED TODO (7) Get the integer extra BatteryManager.EXTRA_STATUS. Check if it matches
            // BatteryManager.BATTERY_STATUS_CHARGING or BatteryManager.BATTERY_STATUS_FULL. This means
            // the battery is currently charging.
            // COMPLETED TODO (8) Update the UI using your showCharging method
