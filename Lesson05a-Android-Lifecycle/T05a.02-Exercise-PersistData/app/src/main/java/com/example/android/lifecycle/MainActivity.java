...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETED TODO (1) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED TODO (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our TextView
    ...
    // COMPLETED TODO (2) Override onSaveInstanceState

    @Override
    protected void onSaveInstanceState(Bundle outState) {
        // Do steps 3 - 5 within onSaveInstanceState
        // COMPLETED TODO (3) Call super.onSaveInstanceState
        // COMPLETED TODO (4) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
        // COMPLETED TODO (5) Put the text from the TextView in the outState bundle
        super.onSaveInstanceState(outState);
        logAndAppend(ON_SAVE_INSTANCE_STATE);
        String textContents = mLifecycleDisplay.getText().toString();
        outState.putCharSequence(LIFECYCLE_CALLBACKS_TEXT_KEY, textContents);
    }
