...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // COMPLETED TODO (1) Change the name of default setup to setupSharedPreferences

    private void setupSharedPreferences() {
        // COMPLETED TODO (2) Get a reference to the default shared preferences from the PreferenceManager class
        SharedPreferences sharedPreferences =
                PreferenceManager.getDefaultSharedPreferences(this);

        // COMPLETED TODO (3) Get the value of the show_bass checkbox preference and use it to call setShowBass
