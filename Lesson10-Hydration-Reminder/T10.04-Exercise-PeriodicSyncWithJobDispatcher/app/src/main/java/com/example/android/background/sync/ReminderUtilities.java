...
public class ReminderUtilities {
    // COMPLETED TODO (15) Create three constants and one variable:
    ...
    // COMPLETED TODO (16) Create a synchronized, public static method called scheduleChargingReminder that takes
    ...
    synchronized public static void scheduleChargingReminder(@NonNull final Context context) {
        // COMPLETED TODO (17) If the job has already been initialized, return
        if (sInitialized) return;
        // COMPLETED TODO (18) Create a new GooglePlayDriver
        Driver driver = new GooglePlayDriver(context);
        // COMPLETED TODO (19) Create a new FirebaseJobDispatcher with the driver
        FirebaseJobDispatcher dispatcher = new FirebaseJobDispatcher(driver);
        // COMPLETED TODO (20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which:
        ...
        Job constraintReminderJob = dispatcher.newJobBuilder()
                ...
                .build();
        // COMPLETED TODO (21) Use dispatcher's schedule method to schedule the job
        dispatcher.schedule(constraintReminderJob);
        // COMPLETED TODO (22) Set sInitialized to true to mark that we're done setting up the job
        sInitialized = true;
    }
}
