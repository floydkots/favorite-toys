...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        // COMPLETED TODO (5) Create a String that contains a URL ( make sure it starts with http:// or https:// )
        String udacityUrl = "https://www.udacity.com";

        // COMPLETED TODO (6) Replace the Toast with a call to openWebPage, passing in the URL String from the previous step
    ...
    // COMPLETED TODO (1) Create a method called openWebPage that accepts a String as a parameter
    // Do steps 2 - 4 within openWebPage
    public void openWebPage(String urlAsString) {
        // COMPLETED TODO (2) Use Uri.parse to parse the String into a Uri
        Uri webpage = Uri.parse(urlAsString);
        // COMPLETED TODO (3) Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters
